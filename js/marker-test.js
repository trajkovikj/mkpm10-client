...
function initMap() {
  ...
  var marker = new google.maps.Marker({
    position: new google.maps.LatLng(41.9925, 21.423611),
    icon: goldStar,
    title: "Hello",
    label: {
        text: '23',
  ...
  var marker = new google.maps.Marker({
    position: new google.maps.LatLng(42.006667, 21.386944),
    label: {
        text: '323   ',
        color: 'purple'
      },
...
{
    return [
        { location: new google.maps.LatLng(42.006667, 21.386944), weight : 100, radius: 50 },
        { location: new google.maps.LatLng(41.9925, 21.423611), weight : 200, radius: 100 }
    ]
}
